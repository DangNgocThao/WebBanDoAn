...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$magh = GioHang::getMagh($pdo, $tk, false)) {
        ...
        if (!$sl = ChiTietGH::getSoLuong($pdo, $magh, $mamon)) {
            $ctgh = new ChiTietGH();
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <?php if (isset($_SESSION['log_detail'])) : ?>
                            <form method="post">
                                ...
                                <button type="submit" class="btn btn-primary mt-auto align-self-start"><i class="fa-solid fa-cart-plus"></i> Thêm giỏ hàng</button>
                            </form>
                        <?php endif; ?>
                    </div>
                </div>
